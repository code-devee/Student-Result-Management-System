                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Data Structures</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="dsa">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Java Programming</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Computer Architecture</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">DSA Lab</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="dsl">
                                    </div>
                                </div>
                                
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Java Lab</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="jpl">
                                    </div>
                                </div>
...
Designed & Developed by BTech Days Team</h5></center> -->
  <hr class="new1">
<center><h5>All Right Reserved @ Devee :: 2019-2021</h5></center> 
  <hr class="new1">
<br>
</body>
</html>